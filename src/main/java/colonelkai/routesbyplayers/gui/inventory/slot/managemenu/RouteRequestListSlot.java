...
public class RouteRequestListSlot extends Slot {
    public RouteRequestListSlot(@NotNull InventoryTemplate template, int slotIndex) {
        super(template, slotIndex, new ItemStackBuilder()
                        .setName(ChatColor.WHITE + "View Route Requests")
